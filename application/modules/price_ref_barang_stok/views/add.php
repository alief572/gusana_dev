	...
	<div class="box-body">
		<form id="data_form" method="post" autocomplete="off" enctype='multiple/form-data'>
			...
			<div class="form-group row">
				...
				<div class="col-md-5">
					<input type="text" class="form-control autoNumeric" id="price_ref_high" name="price_ref_high" value='<?= $price_ref_new; ?>' placeholder="Lower Pricee After" readonly>
				</div>
			</div>
			<div class="form-group row">
				<div class="col-md-2">
				...
				<div class="col-md-5">
					<input type="text" class="form-control autoNumeric" id="price_ref_new" name="price_ref_new" value='<?= $price_ref_high; ?>' placeholder="Higher Before" readonly>
				</div>
				<div class="col-md-5">
