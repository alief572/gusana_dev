<?php
$ENABLE_ADD     = has_permission('LHP_Mixing_2.Add');
$ENABLE_MANAGE  = has_permission('LHP_Mixing_2.Manage');
$ENABLE_VIEW    = has_permission('LHP_Mixing_2.View');
$ENABLE_DELETE  = has_permission('LHP_Mixing_2.Delete');
?>
