...
class Pr_model extends BF_Model
{
	...
	{
		$this->db->select('a.*, b.customer_name as name_customer');
		$this->db->from('tr_penawaran a');
		$this->db->join('customers b', 'b.id_customer = a.id_customer');
	...
	{
		$this->db->select('a.*, b.customer_name as name_customer, b.address_office as address_office, b.telephone as telephone,b.fax as fax');
		$this->db->from('tr_penawaran a');
		$this->db->join('customers b', 'b.id_customer = a.id_customer');
