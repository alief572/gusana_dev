						...
						<div class="col-sm-12">
							...
							<div class="col-sm-6">
								<div class="form-group row">
									...
									<div class="col-md-8">
										<select id="supplier" name="supplier" class='form-control input-md chosen-select' required>
										...
										<tbody>
											...
											foreach ($results['getitemso'] as $value) {
											  ...
											  <td><input type='text' class='form-control input-sm ch_jumlah_ex auto_num' id='dt_jumlahharga_" . $key . "' readonly name='dt[" . $key . "][jumlahharga]' value='" . $total . "'></td>
												...
												<td><input type='text' class='form-control input-sm auto_num ch_jumlah_ex2' id='dt_totalharga_" . $key . "' readonly name='dt[" . $key . "][totalharga]' value='" . $total . "'></td>
...
<script type="text/javascript">
	...
	function HitAmmount(id) {
		...
		var nilai_ppn = parseFloat(jumlah * persen_ppn / 100);
	...
	function TotalSemua() {
		...
		SUM_JMXX += Number($("#kirim").val().split(",").join(""))
		...
		$("#diskontotal").val(number_format(SUM_DIS));
		$("#taxtotal").val(number_format(SUM_PJK));
		$("#subtotal").val(number_format(SUM_JMXX));
