<?php
$ENABLE_ADD     = has_permission('Log_Approval.Add');
$ENABLE_MANAGE  = has_permission('Log_Approval.Manage');
$ENABLE_VIEW    = has_permission('Log_Approval.View');
$ENABLE_DELETE  = has_permission('Log_Approval.Delete');
?>
