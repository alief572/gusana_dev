<?php
$ENABLE_ADD     = has_permission('Cost_Center.Add');
$ENABLE_MANAGE  = has_permission('Cost_Center.Manage');
$ENABLE_VIEW    = has_permission('Cost_Center.View');
$ENABLE_DELETE  = has_permission('Cost_Center.Delete');
?>
<style type="text/css">
	thead input {
		width: 100%;
