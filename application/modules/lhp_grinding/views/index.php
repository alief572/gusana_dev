<?php
$ENABLE_ADD     = has_permission('LHP_Grinding.Add');
$ENABLE_MANAGE  = has_permission('LHP_Grinding.Manage');
$ENABLE_VIEW    = has_permission('LHP_Grinding.View');
$ENABLE_DELETE  = has_permission('LHP_Grinding.Delete');
?>
