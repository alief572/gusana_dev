    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="form-group row">
                ...
                <div class="col-md-8">
                    <input type="text" class="form-control" id="id_category" name="id_category" readonly placeholder="Auto" value="<?= isset($id_category) ? $id_category : null; ?>">
                </div>
            </div>
            <div class="form-group row">
                <div class="col-md-3 tx-dark tx-bold">
                    <label for="nm_category_supplier">Kategori Supplier</label>
                </div>
                <div class="col-md-8">
                    <input type="text" class="form-control" id="nm_category_supplier" name="nm_category_supplier" placeholder="Kategori Supplier" value="<?= isset($category_suppliers) ? $category_suppliers->nm_category_supplier : null; ?>">
                </div>
            </div>
        </div>
    </div>
