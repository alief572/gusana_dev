    ...
    <div class="row">
        <div class="col-sm-12">
            ...
            <div class="form-group mt-2 row">
                ...
                <div class="col-md-4">
                    <input type="radio" name="status" class="ml-2" id="" value="1" <?= (isset($results['barang_stok']) && $results['barang_stok']->status == 1) ? 'checked' : null ?>> Aktif
                    <input type="radio" name="status" class="ml-2" id="" value="0" <?= (isset($results['barang_stok']) && $results['barang_stok']->status == 0) ? 'checked' : null ?>> Tidak Aktif
                </div>
            </div>
        </div>
    </div>
