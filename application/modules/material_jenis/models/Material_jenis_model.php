...
class Material_jenis_model extends BF_Model
{
    /**
    ...
    {
        $id_bm1 = $this->db->query("SELECT MAX(id_category2) AS max_id FROM ms_inventory_category2")->result_array();
    ...
    public function get_data_category2()
    {
        ...
        $this->db->from('ms_inventory_category2 a', 'left');
