<?php
$ENABLE_ADD     = has_permission('Log_History.Add');
$ENABLE_MANAGE  = has_permission('Log_History.Manage');
$ENABLE_VIEW    = has_permission('Log_History.View');
$ENABLE_DELETE  = has_permission('Log_History.Delete');
?>
