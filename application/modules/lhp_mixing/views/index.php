<?php
$ENABLE_ADD     = has_permission('LHP_Mixing.Add');
$ENABLE_MANAGE  = has_permission('LHP_Mixing.Manage');
$ENABLE_VIEW    = has_permission('LHP_Mixing.View');
$ENABLE_DELETE  = has_permission('LHP_Mixing.Delete');
?>
