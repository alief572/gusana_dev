...
{
    protected $viewPermission     = 'LHP_Coloring.View';
    protected $addPermission      = 'LHP_Coloring.Add';
    protected $managePermission = 'LHP_Coloring.Manage';
    protected $deletePermission = 'LHP_Coloring.Delete';
