<?php
$ENABLE_ADD     = has_permission('LHP_Coloring.Add');
$ENABLE_MANAGE  = has_permission('LHP_Coloring.Manage');
$ENABLE_VIEW    = has_permission('LHP_Coloring.View');
$ENABLE_DELETE  = has_permission('LHP_Coloring.Delete');
?>
