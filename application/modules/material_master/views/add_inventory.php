 <div class="box box-primary">
 	<div class="box-body">
 		<form action="<?= base_url('material_master/saveNewInventory'); ?>" id="data-form" method="post" enctype="multipart/form-data">
 			<div class="col-sm-12">
 				<div class="input_fields_wrap2">
 					...
 					<table class="table" border="0" style="border:none !important;">
 						...
 						<tr style="border:none !important;">
 							...
 							<th colspan="5">
 								<input type="text" name="nm_lv_4" id="" class="form-control form-control-sm nm_lv_4" placeholder="Material Master">
 							</th>
 						</tr>
 						<tr style="border:none !important;">
 							<th>Material Code</th>
 							<th>
 								<input type="text" name="material_code" id="" class="form-control form-control-sm" placeholder="Material Code">
 							</th>
 		...
 		$('#data-form').submit(function(e) {
 			...
 			new swal({
 				...
 				if (hasil.isConfirmed) {
 					...
 					var baseurl = siteurl + 'material_master/saveNewInventory';
 					$.ajax({
 						url: baseurl,
 						type: "POST",
 						data: formData,
