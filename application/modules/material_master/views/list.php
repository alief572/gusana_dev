...
<div class="box">
	<div class="box-header">
		...
		<?php endif; ?>
		<!-- <a class="btn btn-primary btn-sm" href="<?= base_url('/material_master') ?>" title="Detail">Back</a> -->
...
<script type="text/javascript">
	...
	$(document).on("change", ".gabung_nama", function() {
		...
		if (inv_lv_1 !== "" || inv_lv_2 !== "" || inv_lv_3 !== "") {
			$.ajax({
				type: "POST",
				url: siteurl + 'material_master/gabung_nama',
				data: {
					"inv_lv_1": inv_lv_1,
					"inv_lv_2": inv_lv_2,
					"inv_lv_3": inv_lv_3
	...
	$(document).on('click', '.edit', function(e) {
		...
		$.ajax({
			type: 'POST',
			url: siteurl + 'material_master/editInventory/' + id,
			data: {
				"id_type": id_type
			},
	...
	$(document).on('click', '.copy', function(e) {
		...
		$.ajax({
			type: 'POST',
			url: siteurl + 'material_master/copyInventory/' + id,
			success: function(data) {
				$("#dialog-popup").modal();
				$("#ModalView").html(data);
	...
	$(document).on('click', '.view', function() {
		...
		$.ajax({
			type: 'POST',
			url: siteurl + 'material_master/viewInventory/' + id,
			data: {
				'id': id
			},
			success: function(data) {
	...
	$(document).on('click', '.add', function() {
		...
		$.ajax({
			type: 'POST',
			url: siteurl + 'material_master/addInventory/' + id,
			data: {
				'id': id
			},
			success: function(data) {
	...
	$(document).on('click', '.delete', function(e) {
		...
		new swal({
			...
			if (hasil.isConfirmed) {
				$.ajax({
					type: 'POST',
					url: siteurl + 'material_master/deleteInventory',
					dataType: "json",
					data: {
						'id': id
					},
	...
	$(document).on("click", ".add_alt_supplier", function(e) {
		...
		$.ajax({
			type: "POST",
			url: siteurl + 'material_master/addAltSupplier',
			data: {
	...
	$(document).on("click", ".del_inventory_category3_alt_supp", function() {
		...
		$.ajax({
			type: "POST",
			url: siteurl + 'material_master/delAltSupplier',
			data: {
				'id': id,
				'id_category3': id_category3
			},
