				...
				<div class="input_fields_wrap2">
					...
					<table class="table">
						<tr>
							<th>Material Lv 1</th>
							<th>
								<select id="inventory_1" name="hd1[1][inventory_1]" class="form-control form-control-sm inventory_1" onchange="get_inv2()" readonly>
						...
						<tr>
							...
							<th>
								<input type="text" name="hd1[1][nm_lv_4]" id="" class="form-control form-control-sm nm_lv_4" placeholder="Nama Material Lv 4" value="<?= $results['inventory_4']->nama ?>">
							</th>
							<th>Other Name</th>
							<th>
								<input type="text" name="hd1[1][other_name]" id="" class="form-control form-control-sm other_name" placeholder="Other Name" value="<?= $results['inventory_4']->other_name ?>">
							</th>
							<th>Supplier Utama</th>
							<th>
								<div id="slWrapperSupplier" class="parsley-select">
									<select name="hd1[1][supplier_utama]" id="" class="form-control form-control-sm supplier_utama select" data-parsley-inputs data-parsley-class-handler="#slWrapperSupplier" data-parsley-errors-container="#slErrorContainerSupplier">
										<option value="">-- Supplier Utama --</option>
										<?php
										foreach ($results['suppliers'] as $supp) {
											$selected = "";
											if ($supp->id == $results['inventory_4']->supplier_utama) {
												$selected = "selected";
											}
						...
						<tr>
							...
							<th>Lead Time</th>
							<th>
								<input type="text" name="hd1[1][lead_time]" id="" class="form-control form-control-sm lead_time" placeholder="Lead Time" value="<?= $results['inventory_4']->lead_time ?>">
							</th>
							<th>MOQ</th>
							<th>
								<input type="text" name="hd1[1][moq]" id="" class="form-control form-control-sm moq" placeholder="MOQ" value="<?= $results['inventory_4']->moq ?>">
							</th>
						</tr>
						<tr>
							<th>Packaging</th>
						...
						<tr>
							...
							<th>Brand</th>
							<th>
								<input type="text" name="hd1[1][brand]" id="" class="form-control form-control-sm brand" placeholder="Brand" value="<?= $results['inventory_4']->brand ?>">
							</th>
							<th>MSDS</th>
							<th>
								<input type="file" class="form-control form-control-sm" id="" name="msds" size="20" placeholder="msds">
							</th>
						</tr>
					</table>
					<div class="row">
