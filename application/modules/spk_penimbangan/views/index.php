<?php
$ENABLE_ADD     = has_permission('Penimbangan.Add');
$ENABLE_MANAGE  = has_permission('Penimbangan.Manage');
$ENABLE_VIEW    = has_permission('Penimbangan.View');
$ENABLE_DELETE  = has_permission('Penimbangan.Delete');
?>

<div class="br-pagetitle">
    <i class="tx-primary fa-4x <?= $template['page_icon']; ?>"></i>
    <div>
        <h4>SPK Penimbangan</h4>
