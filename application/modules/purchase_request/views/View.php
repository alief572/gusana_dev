								...
								<table class='table table-striped table-bordered table-hover table-condensed' width='100%'>
									<thead class='thead'>
										<tr class='bg-blue'>
											...
											<th class='text-center th'>Packing</th>
											<th class='text-center th'>Qty Pack</th>
									...
									<tbody>
										...
										foreach ($results['detail'] as $key => $value) {
											...
											$check_po_created = $this->db->get_where('dt_trans_po', ['idpr' => $value['id']])->num_rows();

											$status = "<div class='badge bg-red'>PO Not Created</div>";
											if ($check_po_created > 0) {
											...
											echo "	<td class='text-left'>" . $value['unit_measure'] . "</td>";
											echo "	<td class='text-left'>" . $value['satuan_packing'] . "</td>";
											echo "	<td class='text-left'>" . number_format($value['qty_pack']) . "</td>";
