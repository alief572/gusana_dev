...
<div class="br-pagetitle">
    ...
    <div>
        <h4>Price Reference Raw Material</h4>
...
<div class="d-flex align-items-center justify-content-between pd-x-20 pd-sm-x-30 pd-t-25 mg-b-20 mg-sm-b-30">
    ...
    <?php if ($ENABLE_ADD) : ?>
        <!-- <button class="btn btn-primary btn-oblong add" href="javascript:void(0)" title="Add"><i class="fa fa-plus">&nbsp;</i>Add New Price Reference Raw Material</button> -->
...
<div class="modal fade effect-scale" id="dialog-popup" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <form action="<?= base_url('pfs_raw_material/save'); ?>" id="data-form" method="post" enctype="multipart/form-data" data-parsley-validate>
...
<script type="text/javascript">
    ...
    $(document).on('click', '.add', function() {
        $.ajax({
            ...
            success: function(data) {
                $('#dialog-popup .modal-title').html("<span class='<?= $template['page_icon']; ?>'></span>&nbsp;Add New Price Reference Raw Material")
    ...
    $(document).on('click', '.edit', function(e) {
        ...
        $.ajax({
            ...
            success: function(data) {
                $('#dialog-popup .modal-title').html("<span class='<?= $template['page_icon']; ?>'></span>&nbsp;Edit Price Reference Raw Material")
                $('#dialog-popup .modal-dialog').css({
                    'max-width': '90%'
                })
                $("#dialog-popup").modal();
