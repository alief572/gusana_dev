        ...
        <div class="form-group row">
            <div class="col-md-12">
                <table width='100%' class="table table-sm table-bordered">
                    <thead class="thead">
                        <tr>
                            <td colspan='7'><b>PRODUCT NAME :</b> <?= strtoupper(get_name('ms_product_category3', 'nama', 'id_category3', $id_product)); ?></td>
                        </tr>
                        <tr class='bg-blue'>
                        ...
                        if (!empty($header[0]->id_time)) {
                            ...
                            foreach ($q_header_test as $val2 => $val2x) {
                                ...
                                foreach ($q_dheader_test as $val2D => $val2Dx) {
                                    ...
                                    $val2D++;
                                    $CT2 = (get_name('asset', 'nm_asset', 'kd_asset', $val2Dx['machine']) != '0') ? get_name('asset', 'nm_asset', 'id', $val2Dx['machine']) : '';
                                    ...
                                    if ($tanda == 'manpower') {
                                        ...
                                        if ($CT2 != '' and $tanda == 'machine') {
                                            echo "<span class=''>" . $CT2 . "</span>";
                                        }
                                        if ($MP2 != '' and $tanda == 'mold') {
                                            echo "<span class=''>" . $MP2 . "</span>";
                                        }
                                        echo "</td>";
