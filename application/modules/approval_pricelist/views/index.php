            ...
            <table id="dataTable" width="100%" class="table display table-bordered table-hover table-striped border-left-0 border-right-0">
                <thead>
                    <tr>
                        ...
                        <th class="desktop tablet mobile tx-bold tx-dark">Kode Produk</th>
                        <th class="desktop tablet mobile tx-bold tx-dark">Nama Produk</th>
                        <th class="desktop tablet mobile tx-bold tx-dark">Lot Size</th>
                        <th class="desktop tablet mobile tx-bold tx-dark">Pricelist/Kg</th>
                        <th class="desktop tablet mobile tx-bold tx-dark">Expired Price</th>
                        <th class="desktop tablet mobile tx-bold tx-dark">Status</th>
                        <th class="desktop tablet mobile tx-bold tx-dark">App / Reject By</th>
                        <th class="desktop tablet mobile tx-bold tx-dark">App / Reject Date</th>
