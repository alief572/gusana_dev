<?php
$ENABLE_ADD     = has_permission('Goods_release_order.Add');
$ENABLE_MANAGE  = has_permission('Goods_release_order.Manage');
$ENABLE_VIEW    = has_permission('Goods_release_order.View');
$ENABLE_DELETE  = has_permission('Goods_release_order.Delete');
?>
...
<script type="text/javascript">
    ...
    $(document).on('click', '.create_do', function(e) {
        e.preventDefault();
        ...
        swalWithBootstrapButtons.fire({
            title: "Are you sure?",
            text: "Are you sure want to create DO based on this SO ?",
            icon: "question",
            showCancelButton: true,
            confirmButtonText: "<i class='fa fa-check'></i> Yes",
            cancelButtonText: "<i class='fa fa-ban'></i> No",
            ...
            preConfirm: () => {
                return $.ajax({
                    type: 'POST',
                    url: siteurl + thisController + 'create_do',
                    dataType: "JSON",
                    data: {
                        'id': id
                    },
