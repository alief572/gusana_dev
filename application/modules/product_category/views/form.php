 			...
 			<div class="input_fields_wrap2">
 				<div class="row">
 					<div class="form-group row">
 						...
 						<div class="col-md-8 mt-2">
 							<select name="product_type" id="" class="form-control form-control-sm chosen-select" required>
 								...
 								<?php foreach ($results['product_type'] as $product_type) : ?>
 									<option value="<?= $product_type->id_type ?>"><?= $product_type->nama ?></option>
 								<?php endforeach; ?>
 							</select>
 						</div>
 						<div class="col-md-4 mt-2">
 						...
 						<div class="col-md-8 mt-2">
 							<input type="text" class="form-control form-control-sm" id="" required name="nm_product_category" placeholder="Product Category">
 						</div>
 					</div>
 				</div>
 			</div>
