...
<script type="text/javascript">
	$(document).on('click', '.edit', function(e) {
		...
		$.ajax({
			type: 'POST',
			url: siteurl + 'product_jenis/editInventory/' + id,
	...
	$(document).on('click', '.view', function() {
		...
		$.ajax({
			type: 'POST',
			url: siteurl + 'product_jenis/viewInventory/',
			data: {
				'id': id
			},
			success: function(data) {
	...
	$(document).on('click', '.add', function() {
		...
		$.ajax({
			type: 'POST',
			url: siteurl + 'product_jenis/addInventory',
			success: function(data) {
				$("#dialog-popup").modal();
				$("#ModalView").html(data);
	...
	$(document).on('click', '.delete', function(e) {
		...
		new swal({
			...
			$.ajax({
				type: 'POST',
				url: siteurl + 'product_jenis/deleteInventory',
				dataType: "json",
				data: {
					'id': id
				},
	...
	$(document).on('submit', '#data_form', function(e) {
		...
		new swal({
			...
			if (hasil.isConfirmed) {
				...
				$.ajax({
					url: baseurl + 'product_jenis/saveNewinventory',
					type: "POST",
					data: formData,
					cache: false,
					dataType: 'json',
