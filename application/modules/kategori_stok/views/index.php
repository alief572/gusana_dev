<?php
$ENABLE_ADD     = has_permission('Kategori_Stok.Add');
$ENABLE_MANAGE  = has_permission('Kategori_Stok.Manage');
$ENABLE_VIEW    = has_permission('Kategori_Stok.View');
$ENABLE_DELETE  = has_permission('Kategori_Stok.Delete');
?>
...
<div class="d-flex align-items-center justify-content-between pd-x-20 pd-sm-x-30 pd-t-25 mg-b-20 mg-sm-b-30">
    ...
    <div class="btn-group hidden-sm-down">
        <a class="btn btn-primary btn-oblong add" href="javascript:void(0)" data-toggle="tooltip" data-placement="top" title="Add"><i class="fa fa-plus">&nbsp;</i>Add Kategori Stok</a>
    </div><!-- btn-group -->
</div>
            ...
            <table id="dataTable" class="table table-bordered display table-striped border-right-0 border-left-0" width="100%">
                <thead>
                    <tr>
                        ...
                        <th class="desktop tablet mobile tx-bold tx-dark" width="25%">Kategori Stok</th>
                        <th class="desktop tablet mobile tx-bold tx-dark" width="25%">Deskripsi</th>
...
<script type="text/javascript">
    ...
    $(document).on('click', '.add', function() {
        ...
        $("#dialog-popup .modal-title").html('<i class="<?= $template['page_icon']; ?>" aria-hidden="true"></i> Add New Kategori Stok');
        $("#dialog-popup").modal();
    ...
    $(document).on('click', '.edit', function() {
        ...
        if (id) {
            ...
            $("#dialog-popup .modal-title").html('<i class="<?= $template['page_icon']; ?>" aria-hidden="true"></i> Edit Kategori Stok');
        } else {
    ...
    $(document).on('click', '.view', function() {
        ...
        if (id) {
            ...
            $("#dialog-popup .modal-title").html('<i class="<?= $template['page_icon']; ?>" aria-hidden="true"></i> View Kategori Stok');
        } else {
            $("#dialog-popup .modal-body").html("<h5 class='text-center'>Data tidak valid</h5>");
        }
        $("#dialog-popup").modal();
    ...
    $(document).on('click', '.delete', function() {
        ...
        swalWithBootstrapButtons.fire({
            title: "Confirm",
            text: "Are you sure to Delete this data Kategori Stok?",
            icon: "question",
    ...
    $(document).on('submit', '#data-form', function(e) {
        ...
        swalWithBootstrapButtons.fire({
            title: "Confirm",
            text: "Are you sure to save this data Kategori Stok?",
            icon: "question",
            showCancelButton: true,
            confirmButtonText: "<i class='fa fa-check'></i> Yes",
            cancelButtonText: "<i class='fa fa-ban'></i> No",
