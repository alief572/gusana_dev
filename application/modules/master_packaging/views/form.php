        ...
        <div class="col-sm-12">
            <div class="form-group row">
                <div class="col-md-3 tx-dark tx-bold">
                    <label for="id">ID Packaging</label>
                </div>
                <div class="col-md-8">
                    <input type="text" class="form-control" id="id" name="id" readonly placeholder="Auto" value="<?= isset($id_packaging) ? $id_packaging : null; ?>">
                </div>
            </div>
            <div class="form-group row">
                <div class="col-md-3 tx-dark tx-bold">
                ...
                <div class="col-md-8">
                    <input type="text" class="form-control" id="nm_packaging" name="nm_packaging" placeholder="Packaging Name" value="<?= isset($packaging) ? $packaging->nm_packaging : null; ?>">
                </div>
            </div>
        </div>
    </div>
