        ...
        <div class="col-12">
            <table class="table table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        <td colspan="3"></td>
                        <td class="text-center" colspan="3">Discount <?= ($data_penawaran->disc_persen > 0) ? $data_penawaran->disc_persen . '%' : null ?></td>
                        <td class="text-right"><?= number_format($data_penawaran->nilai_disc, 2) ?></td>
                    </tr>
                    <tr>
                        <td colspan="3"></td>
                        <td class="text-center" colspan="3">Price After Discount</td>
                        <td class="text-right"><?= number_format($ttl_harga - $data_penawaran->nilai_disc, 2) ?></td>
                    </tr>
                    <tr>
                        <td colspan="3"></td>
                        <td class="text-center" colspan="3">PPN 11%</td>
