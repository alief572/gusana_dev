 			...
 			<div class="input_fields_wrap2">
 				<div class="row">
 					<div class="form-group row">
 						...
 						<div class="col-md-8">
 							<input type="text" class="form-control form-control-sm" id="" required name="nm_inventory" placeholder="Nama Material Category">
 						</div>
 					</div>
 				</div>
 			</div>
 		...
 		$('#simpan-com').click(function(e) {
 			...
 			new swal({
 				...
 				if (result.isConfirmed) {
 					...
 					var baseurl = siteurl + 'material_category/saveNewinventory';
 					$.ajax({
 						url: baseurl,
 						type: "POST",
 						data: formData,
