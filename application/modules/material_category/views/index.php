	...
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title" id="myModalLabel"><span class="fa fa-file-pdf-o"></span>&nbsp;Data Material Category</h4>
			</div>
...
<div class="modal modal-default fade" id="dialog-popup" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
				<h4 class="modal-title" id="myModalLabel"><span class="fa fa-users"></span>&nbsp;Data Material Category</h4>
			</div>
...
<script type="text/javascript">
	$(document).on('click', '.edit', function(e) {
		...
		$.ajax({
			type: 'POST',
			url: siteurl + 'material_category/editInventory/' + id,
	...
	$(document).on('click', '.view', function() {
		...
		$.ajax({
			type: 'POST',
			url: siteurl + 'material_category/viewInventory/' + id,
			data: {
				'id': id
			},
			success: function(data) {
	...
	$(document).on('click', '.add', function() {
		...
		$.ajax({
			type: 'POST',
			url: siteurl + 'material_category/addInventory',
			success: function(data) {
				$("#dialog-popup").modal();
				$("#ModalView").html(data);
	...
	$(document).on('click', '.delete', function(e) {
		...
		new swal({
			...
			if (hasil.isConfirmed) {
				$.ajax({
					type: 'POST',
					url: siteurl + 'material_category/deleteInventory',
					dataType: "json",
					data: {
						'id': id
					},
