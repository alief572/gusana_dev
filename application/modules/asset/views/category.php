...
<script>
	...
	$(document).on('click', '#add', function(e) {
		e.preventDefault();
		// loading_spinner();
		$("#head_title").html("<b>ADD ASSETS CATEGORY</b>");
		$("#view").load(base_url + 'index.php/' + thisController + '/add_category');
		$("#ModalView").modal();
	});
	...
	$(document).on('click', '.edit', function(e) {
		...
		$("#head_title").html("<b>EDIT ASSETS CATEGORY</b>");
		$("#view").load(base_url + 'index.php/' + thisController + '/add_category/' + id);
		$("#ModalView").modal();
	});
	...
	$(document).on('click', '#save', function() {
		...
		if (nm_category == '') {
			new swal({
				title: "Error Message!",
				text: 'Empty Category Name, please input first ...',
				type: "warning"
			});
		...
		new swal({
			...
			if (hasil.isConfirmed) {
				...
				var baseurl = base_url + thisController + '/add_category';
				$.ajax({
					url: baseurl,
					type: "POST",
					data: formData,
	...
	$(document).on('click', '.delete', function() {
		...
		new swal({
			...
			if (hasil.isConfirmed) {
				// loading_spinner();
				$.ajax({
					url: base_url + 'index.php/' + thisController + '/hapus_category/' + code,
					type: "POST",
					cache: false,
					dataType: 'json',
					processData: false,
	...
	function DataTables() {
		var dataTable = $('#example1').DataTable({
			...
			"ajax": {
				url: base_url + 'index.php/' + thisController + '/data_side_category',
				type: "post",
				data: function(d) {
