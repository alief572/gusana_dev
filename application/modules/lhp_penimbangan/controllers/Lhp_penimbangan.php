...
{
    protected $viewPermission     = 'Penimbangan.View';
    protected $addPermission      = 'Penimbangan.Add';
    protected $managePermission = 'Penimbangan.Manage';
    protected $deletePermission = 'Penimbangan.Delete';
