<?php
$ENABLE_ADD     = has_permission('LHP_Penimbangan.Add');
$ENABLE_MANAGE  = has_permission('LHP_Penimbangan.Manage');
$ENABLE_VIEW    = has_permission('LHP_Penimbangan.View');
$ENABLE_DELETE  = has_permission('LHP_Penimbangan.Delete');
?>

<div class="br-pagetitle">
    <i class="tx-primary fa-4x <?= $template['page_icon']; ?>"></i>
    <div>
        <h4>LHP Penimbangan</h4>
