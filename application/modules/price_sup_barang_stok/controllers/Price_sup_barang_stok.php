...
{
  //Permission
  protected $viewPermission   = 'Sup_Barang_Stok.View';
  protected $addPermission    = 'Sup_Barang_Stok.Add';
  protected $managePermission = 'Sup_Barang_Stok.Manage';
  protected $deletePermission = 'Sup_Barang_Stok.Delete';
