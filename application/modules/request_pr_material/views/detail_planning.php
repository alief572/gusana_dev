						...
						<tbody>
							...
							foreach ($detail as $key => $value) {
								...
								if ($propose > 0) {
									...
									echo "	<td class='text-left'>" . $value['nama'] . "
									...
									if ($value['status_app'] == 'N') {
										echo "<td class='text-center'><div class='badge badge-primary text-bold'>Waiting Process</div></td>";
									}
									if ($value['status_app'] == 'Y') {
										echo "<td class='text-center'><div class='badge badge-success text-bold'>Approved</div></td>";
									}
									if ($value['status_app'] == 'D') {
										echo "<td class='text-center'><div class='badge badge-danger text-bold'>Rejected</div></td>";
									}
									echo "</tr>";
								}
							}
