...
class Warehouse_material_model extends BF_Model
{
  ...
  public function get_json_adjustment()
  {
    ...
    foreach ($query->result_array() as $row) {
      ...
      $nestedData[]  = "<div align='left'>Gusana</div>";
  ...
  public function get_query_json_adjustment($material, $kd_gudang = null, $like_value = NULL, $column_order = NULL, $column_dir = NULL, $limit_start = NULL, $limit_length = NULL)
  {
